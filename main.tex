...
\definecolor{primary_color}{RGB}{37, 150, 190}    % 图标颜色（与页眉完全一致）
\definecolor{secondary_color}{RGB}{37, 150, 190}  % 分割线颜色（与页眉完全一致）
...
% 学院
\newcommand{\school}{软件学院 人工智能学院 | Faculty of Software and AI} 
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.2\textwidth]{images/ynu_logo.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/ynu_logo2.png}
        };
    \end{tikzpicture}
    ...
    \begin{minipage}[t]{0.78\textwidth}
        ...
        {\large \textbf{云南大学}}，专科 \hfill 2000年9月--2010年6月
        \begin{itemize}
            \item 你的学院，你的专业
        ...
        \vspace{0.5em}
        {\large \textbf{云南大学}}，本科 \hfill 2010年9月--2020年6月
        \begin{itemize}
            \item 你的学院，你的专业
            \item \textbf{主修课程}：课程1、课程2、课程3、课程4\ 等。
        ...
        \vspace{0.5em}
        {\large \textbf{云南大学}}，硕士 \hfill 2020年9月--至今
        \begin{itemize}
